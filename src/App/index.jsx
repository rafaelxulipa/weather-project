...
import logomarca from "../images/logowhite.png"

export function App() {  
  const [inputCity, setInputCity] = useState('')
  const [searchedCity, setSearchedCity] = useState('Limoeiro')
  ...
  return (
    <div className="container">
      ...
      <footer style={{alignItems: 'center', display: 'flex', justifyContent: 'center',}}>
        <img src={logomarca} alt="logomarca" width={300}/>
      </footer>
    </div>
    )   
}